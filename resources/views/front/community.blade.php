...
<head>
    ...
    <link href="{{url('chat/assets/css/bootstrap-dark.min.css')}}" id="bootstrap-dark-style" rel="stylesheet" type="text/css" />
    <link href="{{url('chat/assets/css/bootstrap.min.css')}}" id="bootstrap-style" rel="stylesheet" type="text/css" />
            ...
            <div class="tab-pane" id="pills-user" role="tabpanel" aria-labelledby="pills-user-tab">
                <div>
                    <div class="text-center p-4 border-bottom">
                        <div class="mb-4">
                            <img src="{{url('chat/assets/images/users/avatar-1.jpg')}}" class="rounded-circle avatar-lg img-thumbnail" alt="">
                        </div>
                            ...
                            <ul class="list-unstyled chat-list chat-user-list">
                                    ...
                                    <a href="#">
                                        <div class="d-flex">
                                            <div class="chat-user-img online align-self-center me-3 ms-0">
                                                <img src="{{url('chat/assets/images/users/avatar-4.jpg')}}" class="rounded-circle avatar-xs" alt="">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="d-flex">                            
                                            <div class="chat-user-img online align-self-center me-3 ms-0">
                                                <img src="{{url('chat/assets/images/users/avatar-2.jpg')}}" class="rounded-circle avatar-xs" alt="">
                                    ...
                                    <a href="#">
                                        <div class="d-flex">
                                            <div class="chat-user-img away align-self-center me-3 ms-0">
                                                <img src="{{url('chat/assets/images/users/avatar-3.jpg')}}" class="rounded-circle avatar-xs" alt="">
                                                {{-- <span class="user-status"></span> --}}
                                            </div>
                                            <div class="flex-1 overflow-hidden">
                ...
                <div class="modal-body">
                    <div class="text-center p-4">
                        <div class="avatar-lg mx-auto mb-4">
                            <img src="{{url('chat/assets/images/users/avatar-4.jpg')}}" alt="" class="img-thumbnail rounded-circle">
                        </div>
