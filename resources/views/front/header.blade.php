        ...
        <div class="row align-items-center">
            <div class="col-md-2">
                <div class="headerlogo">
                    <a href="index.html"><img class="img-fluid" src="{{url('assets/images/headerLogo.png')}}" alt=""></a>
                </div>
            </div>
            <div class="col-md-1"></div>
            <div class=" col-md-7 mx-auto ">
                <div class="d-flex   align-items-center headerSearchBColor ">
                    <img class="img-fluid ml-2 mr-2 " src="{{url('assets/images/icons/searechIcon.png')}}" alt="search"> 
                ...
                <div class="row align-items-center tools">
                    <div class="col-md-3 col-sm-4 col-4">
                        <div class="iconsBackgroundBox">
                            <a href="chat.html"> <img class="img-fluid" src="{{url('assets/images/icons/emailIcon.png')}}" /></a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-4">
                        <div class="iconsBackgroundBox ">
                            <a href="notification.html"><img class="img-fluid " src="{{url('assets/images/icons/notificationBellIcon.png')}}" /></a>
                            <div class="notificationDot"></div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-4">
                        <a href="profile.html"> <img class="circularImage" src="{{url('assets/images/profile.png')}}" /></a>
